...
if(${XCODEBUILD_PLATFORM} IN_LIST VALID_PLATFORMS)
  if("${XCODEBUILD_PLATFORM}" STREQUAL "iOS")
    set(USED_SDK_NAME "iphoneos" CACHE INTERNAL "")
  elseif("${XCODEBUILD_PLATFORM}" STREQUAL "iOSSimulator")
    set(USED_SDK_NAME "iphonesimulator" CACHE INTERNAL "")
  elseif("${XCODEBUILD_PLATFORM}" STREQUAL "macOS")
    set(USED_SDK_NAME "macosx" CACHE INTERNAL "")
  elseif("${XCODEBUILD_PLATFORM}" STREQUAL "tvOS")
    set(USED_SDK_NAME "appletvos" CACHE INTERNAL "")
  elseif("${XCODEBUILD_PLATFORM}" STREQUAL "tvOSSimulator")
    set(USED_SDK_NAME "appletvsimulator" CACHE INTERNAL "")
  elseif("${XCODEBUILD_PLATFORM}" STREQUAL "watchOS")
    set(USED_SDK_NAME "watchos" CACHE INTERNAL "")
  elseif("${XCODEBUILD_PLATFORM}" STREQUAL "watchOSSimulator")
    set(USED_SDK_NAME "watchsimulator" CACHE INTERNAL "")
  endif()
endif()
...
if(NOT BITCODE_ENABLED)
  ...
  set(CMAKE_C_FLAGS "-fembed-bitcode ${CMAKE_C_FLAGS}" CACHE INTERNAL "")
  set(CMAKE_CXX_FLAGS "-fembed-bitcode ${CMAKE_CXX_FLAGS}" CACHE INTERNAL "")
endif()
...
set(CMAKE_OSX_ARCHITECTURES ${ARCHS_LIST} CACHE INTERNAL "")
